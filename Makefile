...
run: fml
	eval './fml &' && sleep 1 && jack_connect fm:output0 system:playback_3 && jack_connect system:midi_capture_4 fm:fml_in && jack_connect system:midi_capture_5 fm:fml_in && wait
